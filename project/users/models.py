...
class Docs(models.Model):
    ...
    applicant_photo = models.ImageField(upload_to="static/user_detail/")
    domicile_certificate = models.ImageField(upload_to="static/user_detail/")
    income_certficate = models.ImageField(upload_to="static/user_detail/")
    caste_certificate = models.ImageField(upload_to="static/user_detail/")
    aadhar_card = models.ImageField(upload_to="static/user_detail/")
    bonafide = models.ImageField(upload_to="static/user_detail/")
    fee_receipt = models.ImageField(upload_to="static/user_detail/")
    passbook = models.ImageField(upload_to="static/user_detail/")
...
class Student(models.Model):
    ...
    ## -- Attached Docs --  It will be unchanged
    # applicant_photo = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # domicile_certificate = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # income_certficate = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # caste_certificate = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # aadhar_card = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # bonafide = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # fee_receipt = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    # passbook = models.OneToOneField(Docs, on_delete = models.SET_NULL)
    
    ## -- Attached Docs --
    attached_docs = models.ForeignKey(Docs, on_delete=models.SET_NULL, null=True, blank=True)
